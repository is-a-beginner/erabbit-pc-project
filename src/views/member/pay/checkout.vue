  ...
  <div class="xtx-pay-checkout-page">
    <div class="container">
      ...
      <div class="wrapper" v-if="order">
        <!-- 收货地址 -->
        <CheckoutAddress @change="changeAddresss" :list="order.userAddresses" />
        <!-- 商品信息 -->
        ...
        <div class="box-body">
          <div class="total">
            ...
            <dl><dt>商品总价：</dt><dd>¥{{ order.summary.totalPayPrice }}</dd></dl>
...
export default {
  ...
  setup () {
    ...
    return { order,changeAddresss,reqParams,submitOrderFn }
  }
}
</script>
